...
def generate_launch_description():
	map_dir = LaunchConfiguration(
		'map',
		default = PathJoinSubstitution([FindPackageShare('mecanum_slam'),'map','cafe_sim.yaml'])
		)
	
	param_dir = LaunchConfiguration(
		'params_file',
		default = PathJoinSubstitution([FindPackageShare('mecanum_navigation'),'config','galactic_initialized_nav2_params.yaml'])
	)
