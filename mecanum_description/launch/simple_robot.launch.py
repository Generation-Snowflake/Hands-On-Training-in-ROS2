...
def generate_launch_description():
  ...
  default_model_path = os.path.join(pkg_share, 'urdf/basic_mobile_robot.urdf.xacro')
  robot_name_in_urdf = 'basic_mobile_bot'
  default_rviz_config_path = os.path.join(pkg_share, 'rviz/mobile_robot_config.rviz')
